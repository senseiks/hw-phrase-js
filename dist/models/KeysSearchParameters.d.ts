...
export declare function KeysSearchParametersFromJSON(json: any): KeysSearchParameters;
export declare function KeysSearchParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): KeysSearchParameters;
export declare function KeysSearchParametersToJSON(value?: KeysSearchParameters | null): any;
