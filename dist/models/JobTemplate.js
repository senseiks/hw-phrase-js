...
exports.JobTemplateToJSON = exports.JobTemplateFromJSONTyped = exports.JobTemplateFromJSON = void 0;
var runtime_1 = require("../runtime");
var _1 = require("./");
function JobTemplateFromJSON(json) {
    return JobTemplateFromJSONTyped(json, false);
}
exports.JobTemplateFromJSON = JobTemplateFromJSON;
function JobTemplateFromJSONTyped(json, ignoreDiscriminator) {
...
exports.JobTemplateFromJSONTyped = JobTemplateFromJSONTyped;
function JobTemplateToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.JobTemplateToJSON = JobTemplateToJSON;
