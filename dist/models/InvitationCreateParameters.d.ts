...
export declare function InvitationCreateParametersFromJSON(json: any): InvitationCreateParameters;
export declare function InvitationCreateParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvitationCreateParameters;
export declare function InvitationCreateParametersToJSON(value?: InvitationCreateParameters | null): any;
