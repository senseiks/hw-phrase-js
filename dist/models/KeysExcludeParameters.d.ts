...
export declare function KeysExcludeParametersFromJSON(json: any): KeysExcludeParameters;
export declare function KeysExcludeParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): KeysExcludeParameters;
export declare function KeysExcludeParametersToJSON(value?: KeysExcludeParameters | null): any;
