...
exports.LocaleDetailsToJSON = exports.LocaleDetailsFromJSONTyped = exports.LocaleDetailsFromJSON = void 0;
var runtime_1 = require("../runtime");
var _1 = require("./");
function LocaleDetailsFromJSON(json) {
    return LocaleDetailsFromJSONTyped(json, false);
}
exports.LocaleDetailsFromJSON = LocaleDetailsFromJSON;
function LocaleDetailsFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'statistics': !(0, runtime_1.exists)(json, 'statistics') ? undefined : (0, _1.LocaleStatisticsFromJSON)(json['statistics']),
    };
}
exports.LocaleDetailsFromJSONTyped = LocaleDetailsFromJSONTyped;
function LocaleDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'statistics': (0, _1.LocaleStatisticsToJSON)(value.statistics),
    };
}
exports.LocaleDetailsToJSON = LocaleDetailsToJSON;
