...
exports.TeamToJSON = exports.TeamFromJSONTyped = exports.TeamFromJSON = void 0;
...
function TeamFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'users': !(0, runtime_1.exists)(json, 'users') ? undefined : (json['users'].map(_1.UserPreviewFromJSON)),
    };
}
...
function TeamToJSON(value) {
    ...
    return {
        ...
        'users': value.users === undefined ? undefined : (value.users.map(_1.UserPreviewToJSON)),
    };
}
