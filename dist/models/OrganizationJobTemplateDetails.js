...
exports.OrganizationJobTemplateDetailsToJSON = exports.OrganizationJobTemplateDetailsFromJSONTyped = exports.OrganizationJobTemplateDetailsFromJSON = void 0;
var runtime_1 = require("../runtime");
var _1 = require("./");
function OrganizationJobTemplateDetailsFromJSON(json) {
    return OrganizationJobTemplateDetailsFromJSONTyped(json, false);
}
exports.OrganizationJobTemplateDetailsFromJSON = OrganizationJobTemplateDetailsFromJSON;
function OrganizationJobTemplateDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
exports.OrganizationJobTemplateDetailsFromJSONTyped = OrganizationJobTemplateDetailsFromJSONTyped;
function OrganizationJobTemplateDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.OrganizationJobTemplateDetailsToJSON = OrganizationJobTemplateDetailsToJSON;
