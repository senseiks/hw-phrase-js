...
exports.GlossaryTermTranslationsApi = void 0;
var runtime = require("../runtime");
var models_1 = require("../models");
/**
 *
 */
var GlossaryTermTranslationsApi = /** @class */ (function (_super) {
    __extends(GlossaryTermTranslationsApi, _super);
    function GlossaryTermTranslationsApi() {
     ...
     */
    GlossaryTermTranslationsApi.prototype.glossaryTermTranslationCreateRaw = function (requestParameters) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/accounts/{account_id}/glossaries/{glossary_id}/terms/{term_id}/translations".replace("{".concat("account_id", "}"), encodeURIComponent(String(requestParameters.accountId))).replace("{".concat("glossary_id", "}"), encodeURIComponent(String(requestParameters.glossaryId))).replace("{".concat("term_id", "}"), encodeURIComponent(String(requestParameters.termId))),
                                method: 'POST',
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, models_1.GlossaryTermTranslationCreateParametersToJSON)(requestParameters.glossaryTermTranslationCreateParameters),
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.GlossaryTermTranslationFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Create a translation for a term
     */
    GlossaryTermTranslationsApi.prototype.glossaryTermTranslationCreate = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.glossaryTermTranslationCreateRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
     ...
     */
    GlossaryTermTranslationsApi.prototype.glossaryTermTranslationDeleteRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/accounts/{account_id}/glossaries/{glossary_id}/terms/{term_id}/translations/{id}".replace("{".concat("account_id", "}"), encodeURIComponent(String(requestParameters.accountId))).replace("{".concat("glossary_id", "}"), encodeURIComponent(String(requestParameters.glossaryId))).replace("{".concat("term_id", "}"), encodeURIComponent(String(requestParameters.termId))).replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters.id))),
                                method: 'DELETE',
                                headers: headerParameters,
                                query: queryParameters,
                            })];
     ...
     * Delete a translation for a term
     */
    GlossaryTermTranslationsApi.prototype.glossaryTermTranslationDelete = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.glossaryTermTranslationDeleteRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     */
    GlossaryTermTranslationsApi.prototype.glossaryTermTranslationUpdateRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, models_1.GlossaryTermTranslationUpdateParametersToJSON)(requestParameters.glossaryTermTranslationUpdateParameters),
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.GlossaryTermTranslationFromJSON)(jsonValue); })];
     ...
     * Update a translation for a term
     */
    GlossaryTermTranslationsApi.prototype.glossaryTermTranslationUpdate = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.glossaryTermTranslationUpdateRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    return GlossaryTermTranslationsApi;
}(runtime.BaseAPI));
exports.GlossaryTermTranslationsApi = GlossaryTermTranslationsApi;
