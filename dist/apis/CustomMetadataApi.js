...
exports.CustomMetadataApi = void 0;
var runtime = require("../runtime");
var models_1 = require("../models");
/**
 *
 */
var CustomMetadataApi = /** @class */ (function (_super) {
    __extends(CustomMetadataApi, _super);
    function CustomMetadataApi() {
     ...
     * Destroy property
     */
    CustomMetadataApi.prototype.customMetadataPropertiesDeleteRaw = function (requestParameters) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/accounts/{account_id}/custom_metadata/properties/{id}".replace("{".concat("account_id", "}"), encodeURIComponent(String(requestParameters.accountId))).replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters.id))),
                                method: 'DELETE',
     ...
     * Destroy property
     */
    CustomMetadataApi.prototype.customMetadataPropertiesDelete = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.customMetadataPropertiesDeleteRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
     ...
     * List properties
     */
    CustomMetadataApi.prototype.customMetadataPropertiesListRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/accounts/{account_id}/custom_metadata/properties".replace("{".concat("account_id", "}"), encodeURIComponent(String(requestParameters.accountId))),
                                method: 'GET',
                                headers: headerParameters,
                                query: queryParameters,
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return jsonValue.map(models_1.CustomMetadataPropertyFromJSON); })];
                }
            });
        });
    };
     ...
     * List properties
     */
    CustomMetadataApi.prototype.customMetadataPropertiesList = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.customMetadataPropertiesListRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Create a property
     */
    CustomMetadataApi.prototype.customMetadataPropertyCreateRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, models_1.CustomMetadataPropertiesCreateParametersToJSON)(requestParameters.customMetadataPropertiesCreateParameters),
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.CustomMetadataPropertyFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Create a property
     */
    CustomMetadataApi.prototype.customMetadataPropertyCreate = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.customMetadataPropertyCreateRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     */
    CustomMetadataApi.prototype.customMetadataPropertyShowRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Get a single property
     */
    CustomMetadataApi.prototype.customMetadataPropertyShow = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.customMetadataPropertyShowRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Update a property
     */
    CustomMetadataApi.prototype.customMetadataPropertyUpdateRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, models_1.CustomMetadataPropertiesUpdateParametersToJSON)(requestParameters.customMetadataPropertiesUpdateParameters),
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.CustomMetadataPropertyFromJSON)(jsonValue); })];
     ...
     * Update a property
     */
    CustomMetadataApi.prototype.customMetadataPropertyUpdate = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.customMetadataPropertyUpdateRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    return CustomMetadataApi;
}(runtime.BaseAPI));
exports.CustomMetadataApi = CustomMetadataApi;
