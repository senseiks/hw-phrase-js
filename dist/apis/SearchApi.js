...
var SearchApi = /** @class */ (function (_super) {
     ...
     */
    SearchApi.prototype.searchInAccountRaw = function (requestParameters) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/accounts/{account_id}/search".replace("{".concat("account_id", "}"), encodeURIComponent(String(requestParameters.accountId))),
                                method: 'POST',
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, models_1.SearchInAccountParametersToJSON)(requestParameters.searchInAccountParameters),
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.AccountSearchResultFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Search across projects
     */
    SearchApi.prototype.searchInAccount = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.searchInAccountRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
