...
exports.BitbucketSyncApi = void 0;
var runtime = require("../runtime");
var models_1 = require("../models");
/**
 *
 */
var BitbucketSyncApi = /** @class */ (function (_super) {
    __extends(BitbucketSyncApi, _super);
    function BitbucketSyncApi() {
     ...
     */
    BitbucketSyncApi.prototype.bitbucketSyncExportRaw = function (requestParameters) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/bitbucket_syncs/{id}/export".replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters.id))),
                                method: 'POST',
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, models_1.BitbucketSyncExportParametersToJSON)(requestParameters.bitbucketSyncExportParameters),
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.BitbucketSyncExportResponseFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Export from Phrase Strings to Bitbucket
     */
    BitbucketSyncApi.prototype.bitbucketSyncExport = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.bitbucketSyncExportRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
     ...
     */
    BitbucketSyncApi.prototype.bitbucketSyncImportRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/bitbucket_syncs/{id}/import".replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters.id))),
                                method: 'POST',
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, models_1.BitbucketSyncImportParametersToJSON)(requestParameters.bitbucketSyncImportParameters),
                            })];
                    case 1:
                        response = _a.sent();
     ...
     * Import to Phrase Strings from Bitbucket
     */
    BitbucketSyncApi.prototype.bitbucketSyncImport = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.bitbucketSyncImportRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     */
    BitbucketSyncApi.prototype.bitbucketSyncsListRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return jsonValue.map(models_1.BitbucketSyncFromJSON); })];
                }
            });
        });
    };
     ...
     * List Bitbucket syncs
     */
    BitbucketSyncApi.prototype.bitbucketSyncsList = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.bitbucketSyncsListRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    return BitbucketSyncApi;
}(runtime.BaseAPI));
exports.BitbucketSyncApi = BitbucketSyncApi;
