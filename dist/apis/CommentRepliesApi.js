...
exports.CommentRepliesApi = void 0;
var runtime = require("../runtime");
var models_1 = require("../models");
/**
 *
 */
var CommentRepliesApi = /** @class */ (function (_super) {
    __extends(CommentRepliesApi, _super);
    function CommentRepliesApi() {
     ...
     * List replies
     */
    CommentRepliesApi.prototype.repliesListRaw = function (requestParameters) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/projects/{project_id}/keys/{key_id}/comments/{comment_id}/replies".replace("{".concat("project_id", "}"), encodeURIComponent(String(requestParameters.projectId))).replace("{".concat("key_id", "}"), encodeURIComponent(String(requestParameters.keyId))).replace("{".concat("comment_id", "}"), encodeURIComponent(String(requestParameters.commentId))),
                                method: 'GET',
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, models_1.RepliesListParametersToJSON)(requestParameters.repliesListParameters),
                            })];
                    case 1:
                        response = _a.sent();
     ...
     * List replies
     */
    CommentRepliesApi.prototype.repliesList = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repliesListRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
     ...
     * Create a reply
     */
    CommentRepliesApi.prototype.replyCreateRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Create a reply
     */
    CommentRepliesApi.prototype.replyCreate = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.replyCreateRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Delete a reply
     */
    CommentRepliesApi.prototype.replyDeleteRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Delete a reply
     */
    CommentRepliesApi.prototype.replyDelete = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.replyDeleteRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Mark a reply as read
     */
    CommentRepliesApi.prototype.replyMarkAsReadRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/projects/{project_id}/keys/{key_id}/comments/{comment_id}/replies/{id}/mark_as_read".replace("{".concat("project_id", "}"), encodeURIComponent(String(requestParameters.projectId))).replace("{".concat("key_id", "}"), encodeURIComponent(String(requestParameters.keyId))).replace("{".concat("comment_id", "}"), encodeURIComponent(String(requestParameters.commentId))).replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters.id))),
                                method: 'PATCH',
                                headers: headerParameters,
                                query: queryParameters,
                            })];
     ...
     * Mark a reply as read
     */
    CommentRepliesApi.prototype.replyMarkAsRead = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.replyMarkAsReadRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Mark a reply as unread
     */
    CommentRepliesApi.prototype.replyMarkAsUnreadRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/projects/{project_id}/keys/{key_id}/comments/{comment_id}/replies/{id}/mark_as_unread".replace("{".concat("project_id", "}"), encodeURIComponent(String(requestParameters.projectId))).replace("{".concat("key_id", "}"), encodeURIComponent(String(requestParameters.keyId))).replace("{".concat("comment_id", "}"), encodeURIComponent(String(requestParameters.commentId))).replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters.id))),
                                method: 'PATCH',
                                headers: headerParameters,
                                query: queryParameters,
                            })];
     ...
     * Mark a reply as unread
     */
    CommentRepliesApi.prototype.replyMarkAsUnread = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.replyMarkAsUnreadRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Get a single reply
     */
    CommentRepliesApi.prototype.replyShowRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Get a single reply
     */
    CommentRepliesApi.prototype.replyShow = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.replyShowRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    return CommentRepliesApi;
}(runtime.BaseAPI));
exports.CommentRepliesApi = CommentRepliesApi;
