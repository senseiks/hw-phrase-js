...
exports.JobTemplateLocalesApi = void 0;
var runtime = require("../runtime");
var models_1 = require("../models");
/**
 *
 */
var JobTemplateLocalesApi = /** @class */ (function (_super) {
    __extends(JobTemplateLocalesApi, _super);
    function JobTemplateLocalesApi() {
     ...
     */
    JobTemplateLocalesApi.prototype.jobTemplateLocaleDeleteRaw = function (requestParameters) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/projects/{project_id}/job_templates/{job_template_id}/locales/{job_template_locale_id}".replace("{".concat("project_id", "}"), encodeURIComponent(String(requestParameters.projectId))).replace("{".concat("job_template_id", "}"), encodeURIComponent(String(requestParameters.jobTemplateId))).replace("{".concat("job_template_locale_id", "}"), encodeURIComponent(String(requestParameters.jobTemplateLocaleId))),
                                method: 'DELETE',
     ...
     * Delete a job template locale
     */
    JobTemplateLocalesApi.prototype.jobTemplateLocaleDelete = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.jobTemplateLocaleDeleteRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
     ...
     */
    JobTemplateLocalesApi.prototype.jobTemplateLocaleShowRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Get a single job template locale
     */
    JobTemplateLocalesApi.prototype.jobTemplateLocaleShow = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.jobTemplateLocaleShowRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     */
    JobTemplateLocalesApi.prototype.jobTemplateLocaleUpdateRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, models_1.JobTemplateLocaleUpdateParametersToJSON)(requestParameters.jobTemplateLocaleUpdateParameters),
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.JobTemplateLocalesFromJSON)(jsonValue); })];
     ...
     * Update a job template locale
     */
    JobTemplateLocalesApi.prototype.jobTemplateLocaleUpdate = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.jobTemplateLocaleUpdateRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     */
    JobTemplateLocalesApi.prototype.jobTemplateLocalesCreateRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/projects/{project_id}/job_templates/{job_template_id}/locales".replace("{".concat("project_id", "}"), encodeURIComponent(String(requestParameters.projectId))).replace("{".concat("job_template_id", "}"), encodeURIComponent(String(requestParameters.jobTemplateId))),
                                method: 'POST',
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, models_1.JobTemplateLocalesCreateParametersToJSON)(requestParameters.jobTemplateLocalesCreateParameters),
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.JobTemplateLocalesFromJSON)(jsonValue); })];
     ...
     * Create a job template locale
     */
    JobTemplateLocalesApi.prototype.jobTemplateLocalesCreate = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.jobTemplateLocalesCreateRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     */
    JobTemplateLocalesApi.prototype.jobTemplateLocalesListRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * List job template locales
     */
    JobTemplateLocalesApi.prototype.jobTemplateLocalesList = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.jobTemplateLocalesListRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    return JobTemplateLocalesApi;
}(runtime.BaseAPI));
exports.JobTemplateLocalesApi = JobTemplateLocalesApi;
