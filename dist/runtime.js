...
exports.BASE_PATH = "https://api.phrase.com/v2".replace(/\/+$/, "");
...
var BaseAPI = /** @class */ (function () {
    ...
    BaseAPI.prototype.flattenDeepParams = function (obj, prefix) {
        var _this = this;
        var res = [];
        if ((obj === null || obj === void 0 ? void 0 : obj.constructor) === Array) {
            obj.forEach(function (value) {
                res = res.concat(_this.flattenDeepParams(value, "".concat(prefix, "[]")));
            });
        }
        else if ((obj === null || obj === void 0 ? void 0 : obj.constructor) === Object) {
            for (var key in obj) {
                res = res.concat(this.flattenDeepParams(obj[key], prefix ? "".concat(prefix, "[").concat(key, "]") : key));
            }
        }
        else {
            res = [[prefix, obj]];
...
var Configuration = /** @class */ (function () {
    function Configuration(configuration) {
        ...
        configuration.headers["User-Agent"] = "OpenAPI-Generator/1.18.0/js";
    }
